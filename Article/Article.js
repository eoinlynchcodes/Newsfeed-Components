...
function renderData(
  ...
  box.append(paragraphOne);
  box.append(paragraphTwo);
...
data.forEach(dataItem => {
  connection.append(
    renderData(dataItem.title, dataItem.date, dataItem.firstParagraph, dataItem.secondParagraph, data.thirdParagraph)
  );
});